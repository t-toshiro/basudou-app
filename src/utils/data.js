...
export const ROSTER = [
  ...
  { id: 17, name: "清水 陽向", position: "front" },
  { id: 18, name: "斎藤 凌",   position: "back"  },
  { id: 19, name: "山口 湊",   position: "front" },
  { id: 20, name: "池田 蒼太", position: "back"  },
  { id: 21, name: "橋本 樹",   position: "front" },
  { id: 22, name: "石川 碧",   position: "back"  },
  { id: 23, name: "前田 悠真", position: "front" },
  { id: 24, name: "藤田 煌",   position: "back"  },
  { id: 25, name: "岡田 司",   position: "front" },
  { id: 26, name: "後藤 颯真", position: "back"  },
  { id: 27, name: "西村 朔",   position: "front" },
  { id: 28, name: "福田 蓮太", position: "back"  },
  { id: 29, name: "坂本 昊",   position: "front" },
  { id: 30, name: "遠藤 碧斗", position: "back"  },
];
